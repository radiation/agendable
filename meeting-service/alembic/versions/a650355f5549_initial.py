...
Revision ID: a650355f5549
Revises:
Create Date: 2025-07-27 13:58:15.459512
...
def upgrade() -> None:
    ...
    op.create_index('ix_recurrence_created_at', 'recurrences', ['created_at'], unique=False)
    ...
    sa.Column('num_reschedules', sa.Integer(), nullable=False),
